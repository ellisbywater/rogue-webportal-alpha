      ...
      <div className="w-full bg-gray-900 p-10">
        <div className="md:flex items-center border-b pb-6 border-gray-200">
          <div className="flex items-center md:mt-0 mt-4">
            ...
            <p className="text-base ml-3 font-medium leading-4 text-gray-200">
              Sign Up
            </p>
          </div>
        ...
        <h1
          ...
          className="focus:outline-none text-3xl font-bold text-gray-200 mt-12">
          Profile info
        </h1>
        <p
          role="contentinfo"
          className=" focus:outline-nonetext-sm font-light leading-tight text-gray-300 mt-4">
        ...
        <h2
          ...
          className="text-xl font-semibold leading-7 text-gray-200 mt-10">
          Personal data
        </h2>
        <p className="text-sm font-light leading-none text-gray-300 mt-0.5">
          Your details and place of birth
        </p>
        <div className="mt-8 md:flex items-center">
          <div className="flex flex-col">
            <label className="mb-3 text-sm leading-none text-gray-200">
              First name
            </label>
            <input
              type="name"
              ...
              className="w-64 bg-gray-800 text-sm font-medium leading-none text-gray-200 p-3 border rounded border-gray-200"
        ...
        <div className="mt-12">
          <div className="py-4 flex items-center">
            ...
            <p className="text-md leading-none ml-2 text-gray-200">
              I agree with the{" "}
        ...
        <button
          ...
          className="flex items-center justify-center py-4 px-7 focus:outline-none bg-green-700  rounded  mt-7 md:mt-14 hover:bg-green-800  focus:ring-2 focus:ring-offset-2 focus:ring-gray-700">
          <span className="text-sm font-medium text-center text-gray-200 capitalize">
            Next Step
          </span>
          <svg
            className="mt-1 ml-3"
