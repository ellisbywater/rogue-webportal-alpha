      ...
      <div className="bg-gray-900">
        <section className="mx-auto container w-full py-36">
          <div className="flex flex-col justify-center items-center">
            <div className="md:text-2xl text-xl text-center text-gray-100 leading-snug lg:w-3/4">
            ...
            <div className="relative flex items-center justify-center">
              <input
                ...
                className="bg-gray-200 border rounded text-base font-medium leading-none text-gray-800 py-3 px-6 w-11/12 mt-2"
              />
              <div
            ...
            <div className="mt-5 md:text-2xl text-xl text-center text-gray-100 leading-snug lg:w-3/4">
