  ...
  return (
    <DashboardLayout>
      <div className="md:ml-60 md:w-80 text-center">
        <h1 className="text-3xl text-white my-12">Personal Information</h1>
        <form className="text-center w-full flex flex-col justify-center">
          ...
          <div className="my-6">
            <label className="text-sm leading-none text-gray-200" id="lastName">
              Last name
            </label>
            <input
              type="name"
          ...
          <div className="my-6">
            ...
            <input
              type="email"
              tabIndex="0"
              className="w-full p-3 mt-3 bg-gray-800 border rounded border-gray-200 focus:outline-none focus:border-green-700 text-sm font-medium leading-none text-gray-200"
