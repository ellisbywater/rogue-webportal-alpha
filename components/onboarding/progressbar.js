  ...
  return (
    <>
      <div className="w-11/12 lg:w-2/6 mx-auto">
        <div className="bg-gray-800 h-1 flex items-center justify-between">
          <div className="w-1/3 bg-green-700 h-1 flex items-center">
            <div className="bg-green-700 h-6 w-6 rounded-full shadow flex items-center justify-center">
              <svg
          ...
          <div className="w-1/3 flex justify-between bg-indigo-700 h-1 items-center relative">
            ...
            <div className="bg-green-700 h-6 w-6 rounded-full shadow flex items-center justify-center -ml-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-check"
                width={18}
