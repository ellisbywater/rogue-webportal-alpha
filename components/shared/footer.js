        ...
        <div className=" border-t border-b border-gray-200 border-gray-700 py-16">
          <div className="mx-auto container px-4 xl:px-12 2xl:px-4">
            <div className="lg:flex justify-center">
              <div className="w-full lg:w-1/3 mb-16 lg:mb-0 flex">
              ...
              <div className="w-full lg:w-1/3 flex">
                ...
                <div className="w-full lg:w-1/3 px-6 flex flex-col justify-between">
                  <div className="flex items-center mb-6">
                    <a href="javascript:void(0)">
                      <div className="text-gray-50 cursor-pointer hover:text-brand ">
                        <svg
                    ...
                    <a href="javascript:void(0)">
                      <div className="pl-4">
                        <svg
                          className="footer-icon feather feather-twitter text-gray-50 cursor-pointerhover:text-brand "
                          xmlns="http://www.w3.org/2000/svg"
                          width={24}
                          height={24}
                          viewBox="0 0 24 24"
