        ...
        <div className="flex flex-no-wrap">
          ...
          <div className="absolute lg:relative w-64 h-screen bg-gray-900 hidden lg:block">
            ...
            <ul aria-orientation="vertical" className=" py-6">
              <li className="pl-6 cursor-pointer text-white text-sm leading-3 tracking-normal pb-4 pt-5 text-green-700 focus:text-green-700 focus:outline-none">
              ...
              <li className="pl-6 cursor-pointer text-gray-100 text-sm leading-3 tracking-normal mb-4 py-2 hover:text-green-700 focus:text-green-700 focus:outline-none">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="icon icon-tabler icon-tabler-chart"
                    width={20}
                    height={20}
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
              ...
              <li className="pl-6 cursor-pointer text-gray-200 text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-green-700 focus:text-green-700 focus:outline-none">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="icon icon-tabler icon-tabler-layers"
                    width={20}
                    height={20}
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
                  ...
                  <span className="ml-2">Investments</span>
                </div>
              </li>
              <li className="pl-6 cursor-pointer text-gray-200 text-sm leading-3 tracking-normal py-2 hover:text-green-700 focus:text-green-700 focus:outline-none">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="icon icon-tabler icon-tabler-cog"
                    width={20}
                    height={20}
                    viewBox="0 0 24 24"
                    strokeWidth="1.5"
          ...
          <div
            ...
            id="mobile-nav">
            <div
              className="bg-gray-900 opacity-50 absolute h-full w-full lg:hidden"
              ...
              <div className="flex flex-col justify-between h-full w-full">
                <div>
                  ...
                  <ul aria-orientation="vertical" className=" py-6">
                    ...
                    <li className="pl-6 cursor-pointer text-gray-200 text-sm leading-3 tracking-normal mb-4 py-2 hover:text-green-700 focus:text-green-700 focus:outline-none">
                      <div className="flex items-center">
                        <div className="w-6 h-6 md:w-8 md:h-8">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="w-full">
                  <div className="flex justify-center mb-4 w-full px-6">
                    <div className="relative w-full">
                      <div className="text-gray-200 absolute ml-4 inset-0 m-auto w-4 h-4">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <input
                        className="bg-gray-800 focus:outline-none rounded w-full text-sm text-gray-200  pl-10 py-2"
                        type="text"
                        placeholder="Search"
                      />
                    </div>
                  ...
                  <div className="border-t border-gray-900">
                    <div className="w-full flex items-center justify-between px-6 pt-1">
                      <div className="flex items-center">
                        ...
                        />
                        <p className="md:text-xl text-gray-200 text-base leading-4 ml-2">
                          Jane Doe
                        </p>
                      </div>
                      <ul className="flex">
          ...
          <div className="w-full">
            {/* Navigation starts */}
            <nav className="h-16 flex items-center lg:items-stretch justify-end lg:justify-between bg-gray-900 relative z-10">
                  ...
                  <div className="w-full flex items-center pl-8 justify-end">
                    <div className="h-full w-20 flex items-center justify-center">
                      <div className="relative cursor-pointer text-gray-200">
                        ...
                        <div className="w-2 h-2 rounded-full bg-green-500 border border-green-500 absolute inset-0 mt-1 mr-1 m-auto" />
                      </div>
                    </div>
                    <div className="h-full w-20 flex items-center justify-center mr-4 cursor-pointer text-gray-200">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="icon icon-tabler icon-tabler-messages"
                        width={28}
                    ...
                    <div
                      ...
                      <div className="rounded-full">
                        {profile ? (
                          <ul className="p-2 w-full bg-gray-800 absolute rounded left-0 shadow mt-12 sm:mt-16 ">
                            <li className="flex w-full justify-between text-gray-200 hover:text-green-700 cursor-pointer items-center">
                              <div className="flex items-center">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li className="flex w-full justify-between text-gray-200 hover:text-green-700 cursor-pointer items-center mt-2">
                              <div className="flex items-center">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="relative">
                          <img
                            ...
                            alt="avatar"
                          />
                          <div className="w-2 h-2 rounded-full bg-green-400 border border-green-700 absolute inset-0 mb-0 mr-0 m-auto" />
                        </div>
                      </div>
                      <p className="text-gray-200 text-sm mx-3">Jane Doe</p>
              ...
              <div
                className="text-gray-200 mr-8 visible lg:hidden relative"
                onClick={() => setShow(!show)}>
                {show ? (
                  " "
                ) : (
