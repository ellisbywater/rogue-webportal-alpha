export default function DashMenu() {
  return (
    <div className="flex flex-no-wrap min-h-full">
      {/* Sidebar starts */}
      {/* Remove class [ hidden ] and replace [ sm:flex ] with [ flex ] */}
      <div className="w-64 absolute sm:relative bg-gray-900 md:h-full flex-col justify-between hidden sm:flex">
        <div className="px-8">
          <ul className="mt-16">
            <li className="flex w-full justify-between text-gray-100 hover:text-gray-200 cursor-pointer items-center mb-6">
            ...
            <li className="flex w-full justify-between text-gray-100 hover:text-gray-200 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Investments</span>
              </div>
            </li>
            <li className="flex w-full justify-between text-gray-100 hover:text-gray-200 cursor-pointer items-center mb-6">
              <div className="flex items-center">
            ...
            <li className="flex w-full justify-between text-gray-100 hover:text-gray-200 cursor-pointer items-center mb-6">
              <div className="flex items-center">
                ...
                <span className="text-sm  ml-2">Integrations</span>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div
        className="w-64 z-40 absolute bg-gray-900 shadow md:h-full flex-col justify-between sm:hidden  transition duration-150 ease-in-out"
        id="mobile-nav">
        <div
          className="h-10 w-10 bg-gray-900 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer"
          id="mobile-toggler"
