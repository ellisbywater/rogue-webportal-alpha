        ...
        <div className="md:mt-24 f-f-p">
          <div className="hidden md:flex justify-center w-full">
            ...
            <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
              ...
              <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
                ...
                <h2 className="focus:outline-none text-green-700 mt-3 text-base leading-6 tracking-wide">Sign up on our website and opt for a program that suits you the best . </h2>
              </div>
              ...
              <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
                ...
                <h2 className="focus:outline-none text-green-700 mt-3 text-base leading-6 tracking-wide">Start transactions right away. No more complicated process for anything else.</h2>
              </div>
            </div>
          </div>
          <div className="md:hidden flex flex-col items-center w-full">
            ...
            <div className="mt-10">
              ...
              <h2 className="text-green-700 mt-3 pl-3 text-center text-base leading-6 tracking-wide">Create a wallet by linking a payment method that you’re comfortable with. Paypal, Visa and more</h2>
            </div>
            ...
            <div className="flex mt-10 flex-col items-center md:items-start md:w-8/12">
              ...
              <h2 className="text-green-700 mt-3 text-center text-base leading-6 tracking-wide">Start transactions right away. No more complicated process for anything else.</h2>
            </div>
          </div>
        </div>
      </div>
